...
async def tryon_wardrobe(body: TryOnWardrobeRequest):
    ...
    Step 1: Gemini selects only the pieces that form a coherent outfit.
    Step 2: Sends clean garment crops + user photo to Gemini Image for compositing.
    """
    import base64
    ...
    # Step 1: Let Gemini pick only the pieces that form a coherent outfit
    ...
    # Step 2: Build clean garment images (RGB on white — no alpha artifacts)
